#!/bin/bash -e
#SBATCH --job-name=bash1
#SBATCH --output=/lustre/scratch/client/movian/research/users/vietdt11/prompt_cl/prompt_cl_2/vpt1.out
#SBATCH --error=/lustre/scratch/client/movian/research/users/vietdt11/prompt_cl/prompt_cl_2/vpt1.err
#SBATCH --nodes=1
